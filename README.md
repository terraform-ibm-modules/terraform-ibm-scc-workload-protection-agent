...
| <a name="input_universal_ebpf"></a> [universal\_ebpf](#input\_universal\_ebpf) | Deploy Workload Protection agent with universal eBPF enabled. It requires kernel version 5.8+. | `bool` | `false` | no |
