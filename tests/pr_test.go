...
func TestFullyConfigurableDAInSchematics(t *testing.T) {
	...
	if existErr != nil {
		...
		options.TerraformVars = []testschematic.TestSchematicTerraformVar{
			...
			{Name: "existing_cluster", Value: terraform.Output(t, existingTerraformOptions, "cluster_name"), DataType: "string"},
			{Name: "cluster_resource_group", Value: terraform.Output(t, existingTerraformOptions, "resource_group_id"), DataType: "string"},
