...
locals {
  ...
  vuln_host_scanner_image_tag_digest         = "0.12.0@sha256:6d01ff1096bed7fc7f36c46c0a96bb92a21a5bd2afb33498a7fa76a10269eac1" # datasource: icr.io/ibm-iac/vuln-host-scanner
