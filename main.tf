...
locals {
  ...
  cluster_shield_image_tag_digest            = "1.7.1@sha256:b703e76de400d77c35eb6d2f97783462218b684df512893ce6585a76a314e6ba" # datasource: icr.io/ext/sysdig/cluster-shield
